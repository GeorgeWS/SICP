...
(A 0 (A 0 (A 0 (A 0 (A 0 (A 0 1024)))))) ;; Substitution of 1024 for (A 1 10)
...
(A 2 (A 0 2))
(A 2 4)
65536 ;; Substitution of 65536 for (A 2 4)
...
…(A 1 (A 1 (A 1 (A 2 1))))
;; reduce like so (omitting intermediate steps by substituting mathematical definition of g(n) for (A 1 n)) (n - 1) times:
…(A 1 (A 1 (A 1 2)))
